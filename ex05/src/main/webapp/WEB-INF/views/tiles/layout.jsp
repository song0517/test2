            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="${pageContext.request.contextPath}/emp/list">사원관리</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/dept/list">부서관리</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/board/list">게시판</a>
                    </div>
                </div>
            </li>
