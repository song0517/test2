  ...
  <body>
			...
			<div class="ProdSingle">
				<div class="ProdSingleDetail">
					...
					<div class="ProdSingleDetailThumb">
						<img id = "image" src="${place.farmImage }">
					</div>
							...
							<div class="ProdSingleInfo">
								<table class="ProdSingleInfo-table">
									...
									<tbody>
										<tr>
											<th>농업인이름</th>
											<td>${place.farmName }</td>
										</tr>
										<tr>
											<th onclick="openInfoWindow()">주소</th>
											<td onclick="openInfoWindow()">${place.farmAddress }</td>
										</tr>
										<tr>
											<th>연락처</th>
											<td>${place.farmPhone }</td>
										</tr>
										<tr>
											<th>주요판매품목</th>
											<td>${place.farmProduct }</td>
										</tr>
										<tr>
											<th>농장소개</th>
											<td>${place.farmContent }</td>
										</tr>
									</tbody>
								</table>
							</div>
				...
				<button type="submit" class="btn btn-primary py-3 px-4" onClick="location.href='placeList.do'">목록으로</button>
   ...
   <script>
	function openInfoWindow() {
		console.log('클릭OK');
		//console.log(e);
		let lng = ${place.farmLat }
		let lat = ${place.farmLon }
		console.log(lng);
		console.log(lat);
