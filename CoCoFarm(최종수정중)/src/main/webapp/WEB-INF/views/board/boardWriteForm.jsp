...
<div id="show">
	<div>
	<form action="boardWrite.do?writer=${id}" method="post" enctype="multipart/form-data" id="form">
		<table id="writetable" border="1">
				...
				<tr><td class="title"><p>제목</p></td><td><input type="text" id="title" name="title" required></td></tr>
				<tr><td class="title"><p>첨부</p></td><td><input type="file" id="avatar" name="file"></td></tr>
				<tr><td colspan="2" id="textarea"><textarea id="textarea2" cols="124.5" rows="15" name="content"></textarea></td></tr>
