			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
						id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">FARMS</a>
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							<a class="dropdown-item" href="placeList.do">FARMERS</a> 
							<a class="dropdown-item" href="marketList.do">MARKET</a> 
						</div></li>
					...
					<li class="nav-item cta cta-colored">
						<a href="bagList.do?customerId=${id }" class="nav-link"><span class="icon-shopping_cart"></span></a></li>
				</ul>
			</div>
		</div>
	</nav> 
