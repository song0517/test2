		...
		<div class="container">
		  <div class="row">
			<div class="col-lg-8 ftco-animate">  <!-- 사이드바 위치조정에꼭필요 -->
					<form id="frm" action="farmerUpdate.do" method="post"
					class="billing-form" style="width: 600px;">
						<h3 class="mb-4 billing-heading">농장 정보 수정</h3>
						<div class="row align-items-end">
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="form-group">
										...
										<input type="text" class="form-control" value="${farmName }"
										id="farmname" name="farmname" required="required">
									</div>
								</div>
							</div>
							<div class="w-100"></div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="farmphone">농장 전화번호</label> 
									<input type="text" class="form-control" value="${farmPhone }" 
									id="farmphone" name="farmphone" required="required">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="farmacc">농장 사업자 번호</label> 
									<input type="number" class="form-control"
									id="farmacc" name="farmacc" value="${farmAcc }" required="required">
								</div>
							</div>
							<div class="w-100"></div>
							<div class="col-md-6">
