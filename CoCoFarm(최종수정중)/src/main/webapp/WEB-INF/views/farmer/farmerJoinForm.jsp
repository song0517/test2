		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs">
					<span class="mr-2"><a href="main.do">Home</a></span> <span>Farmer Apply</span></p>
					<h1 class="mb-0 bread">Farmer Apply</h1>
				</div>
			</div>
		</div>
</div>	
		...
		<div class="container">
		  <div class="row">
			<div class="col-lg-8 ftco-animate">  <!-- 사이드바 위치조정에꼭필요 -->
					<form id="frm" action="farmerJoin.do" class="billing-form" style="width: 600px;"
						onsubmit="return formSubmit()" method="post">
						<h3 class="mb-4 billing-heading">농업인 신청폼</h3>
						<div class="row align-items-end">
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname">아이디</label> <input type="text"
										class="form-control" placeholder="" type="text" id="id"
										name="id" value="${id }" readonly="readonly">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
										<label for="farmname">농장 사업자 번호</label> 
										<input type="number" class="form-control" id="farmacc" name="farmacc"
											required="required">
								</div>
							</div>
							<div class="w-100"></div>
							<div class="col-md-6">
									<div class="form-group">
										<label for="farmname">농장 이름</label> 
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="farmphone">농장 전화번호</label> <input type="text"
										class="form-control" id="farmphone" name="farmphone"
										required="required">
								</div>
							</div>
							<div class="w-100"></div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="sample6_address">주소</label> <input
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="sample6_extraAddress">상세 주소</label> <input
										type="text" class="form-control" placeholder="extraAddress"
