...
<body>
    ...
    <div class="comment-form-wrap pt-5" id="divReview">
    	<h3 class="mb-5" id="frmTitle">Write Review</h3>
        	<form id="frm" action="inputReview.do?productCode=${productCode}" class="p-5 bg-light" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="reviewContent" id="reviewContent" cols="30" rows="10" class="form-control"></textarea>
                  </div>
                  <div class="form-group">
                    <input type="submit" value="리뷰 게시" class="btn">&nbsp;&nbsp;
