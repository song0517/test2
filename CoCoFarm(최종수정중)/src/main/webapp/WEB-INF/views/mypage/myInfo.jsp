	...
	<div class="container">
	  <div class="row">
		<div class="col-lg-8 ftco-animate">  <!-- 사이드바 위치조정에꼭필요 -->
				<h3 class="heading" style="margin-bottom: 40px;">My Info</h3>
				<table class="type04">
				  <tr>
				    <th scope="row">아이디</th>
				    <td>${id }</td>
				...
				<button type="submit" id="btn" class="btn btn-primary py-3 px-4"
				onclick="location.href='customerDelete.do'" style="margin-top: 30px;">회원 탈퇴하기</button>
		</div> <!-- .col-md-8 -->
		  ...
		  <div class="sidebar-box ftco-animate">
			...
			<ul class="categories">
				...
				<c:if test="${auth eq  'farmer'}">
					...
					<li><a href="farmerUpdate.do">농장 정보 수정</a></li>
