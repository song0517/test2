				...
				<div class="row justify-content-center">
					<div class="col-xl-7 ftco-animate">
						<form id="frm" action="customerJoin.do" class="billing-form" onsubmit="return formSubmit()" method="post">
							<h3 class="mb-4 billing-heading">카카오 로그인 페이지</h3>
							<div class="row align-items-end">
								<div class="col-md-6">
									<div class="form-group">
										<label for="firstname">아이디</label>
										<input type="text" class="form-control" placeholder=""
											type="text" id="id" name="id" value="${kakaoAccount}" readonly="readonly" >
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="sample6_extraAddress">추가 주소</label>
								...
								<div class="col-md-12">
									<div class="form-group mt-4">
										<input type="submit" class="btn btn-primary py-3 px-4" value="가입">&nbsp;&nbsp;&nbsp;
